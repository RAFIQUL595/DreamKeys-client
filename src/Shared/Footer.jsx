...
const ContactSection = () => {
  return (
    <div>
      ...
      <ul className="space-y-2">
        <li className="text-gray-600 dark:text-gray-400">Email: rafiqulislam42002@gmail.com</li>
        <li className="text-gray-600 dark:text-gray-400">Phone: +880 1716697595</li>
        <li className="text-gray-600 dark:text-gray-400">Address: Pabna Sadar,Pabna 6600</li>
      </ul>
    </div>
  );
};
