...
import { FaUsers, FaHome, FaStar, FaHeart, FaGavel, FaDollarSign } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        >
          <div className="flex flex-row items-center justify-between pb-2">
            ...
            <FaHome className="text-2xl text-green-500 dark:text-green-400" />
          </div>
        ...
        >
          <div className="flex flex-row items-center justify-between pb-2">
            ...
            <FaStar className="text-2xl text-yellow-500 dark:text-yellow-400" />
          </div>
        ...
        >
          <div className="flex flex-row items-center justify-between pb-2">
            ...
            <FaHeart className="text-2xl text-red-500 dark:text-red-400" />
          </div>
        ...
        >
          <div className="flex flex-row items-center justify-between pb-2">
            ...
            <FaGavel className="text-2xl text-purple-500 dark:text-purple-400" />
          </div>
        ...
        >
          <div className="flex flex-row items-center justify-between pb-2">
            ...
            <FaDollarSign className="text-2xl text-green-500 dark:text-green-400" />
          </div>
