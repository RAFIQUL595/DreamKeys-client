...
import { FaCheckCircle, FaTimesCircle, FaUser, FaEnvelope, FaCalendarAlt, FaMapMarkerAlt } from 'react-icons/fa';
            ...
            <tbody className="bg-white dark:bg-gray-700">
              {offers.map((offer, idx) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                    <span
                      className={`font-semibold ${offer.offerStatus === "pending"
                          ? "text-yellow-500"
